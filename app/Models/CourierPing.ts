 ...
 *
 * Copied from the framework for the same reason as Courier: the app's
 * scaffolded defaults tree predates the rename. Writes go through
 * `recordCourierPing`, never directly, which is why this has no `useApi`.
 */
